/* Generated By:JavaCC: Do not edit this line. QParJavaParser.java */
import syntaxtree.*;
...
public class QParJavaParser implements QParJavaParserConstants {
  ...
  static final public Goal Goal() throws ParseException {
   ...
   Token n6;
    ...
    n6 = jj_consume_token(0);
     ...
     {if (true) return new Goal(n0,n1,n3,n5);}
  ...
  static final public MainClass MainClass() throws ParseException {
   ...
   Token n51;
    ...
    n27 = jj_consume_token(TRY);
               n26 = JTBToolkit.makeNodeToken(n27);
    n29 = jj_consume_token(LBRACE);
    ...
    n37 = jj_consume_token(CATCH);
                 n36 = JTBToolkit.makeNodeToken(n37);
    n39 = jj_consume_token(LPAREN);
             n38 = JTBToolkit.makeNodeToken(n39);
    n40 = Identifier();
    n41 = Identifier();
    n43 = jj_consume_token(RPAREN);
             n42 = JTBToolkit.makeNodeToken(n43);
    n45 = jj_consume_token(LBRACE);
             n44 = JTBToolkit.makeNodeToken(n45);
    n47 = jj_consume_token(RBRACE);
             n46 = JTBToolkit.makeNodeToken(n47);
    n49 = jj_consume_token(RBRACE);
             n48 = JTBToolkit.makeNodeToken(n49);
    n51 = jj_consume_token(RBRACE);
             n50 = JTBToolkit.makeNodeToken(n51);
     {if (true) return new MainClass(n0,n2,n3,n5,n7,n9,n11,n13,n15,n17,n19,n21,n22,n24,n26,n28,n30,n32,n34,n36,n38,n40,n41,n42,n44,n46,n48,n50);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ClassExtendsDeclaration ClassExtendsDeclaration() throws ParseException {
   ...
   Token n14;
    ...
    n14 = jj_consume_token(RBRACE);
             n13 = JTBToolkit.makeNodeToken(n14);
     {if (true) return new ClassExtendsDeclaration(n0,n2,n3,n5,n7,n9,n11,n13);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public MethodDeclaration MethodDeclaration() throws ParseException {
   ...
   Token n35;
    ...
    n35 = jj_consume_token(RBRACE);
             n34 = JTBToolkit.makeNodeToken(n35);
     {if (true) return new MethodDeclaration(n0,n2,n4,n6,n8,n10,n12,n14,n16,n18,n20,n22,n24,n26,n27,n28,n30,n32,n34);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public QParStatement QParStatement() throws ParseException {
   ...
   Statement n2;
    ...
    while (true) {
     ...
     n0.nodes.trimToSize();
    n2 = Statement();
     {if (true) return new QParStatement(n0,n2);}
    throw new Error("Missing return statement in function");
  }

  static final public Ann Ann() throws ParseException {
   NodeToken n0;
   Token n1;
   Label n2;
   NodeToken n3;
   Token n4;
    n1 = jj_consume_token(SCOMMENT1);
                    n0 = JTBToolkit.makeNodeToken(n1);
    n2 = Label();
    n4 = jj_consume_token(SCOMMENT2);
                    n3 = JTBToolkit.makeNodeToken(n4);
     {if (true) return new Ann(n0,n2,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public SynchStatement SynchStatement() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Statement n7;
    ...
    n6 = jj_consume_token(RPAREN);
            n5 = JTBToolkit.makeNodeToken(n6);
    n7 = Statement();
     {if (true) return new SynchStatement(n0,n2,n4,n5,n7);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public FieldRead FieldRead() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   Identifier n3;
    ...
    n2 = jj_consume_token(DOT);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = Identifier();
     {if (true) return new FieldRead(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public MessageSend MessageSend() throws ParseException {
   ...
   callJoinMethod n5;
    if (jj_2_12(2147483647)) {
     ...
     {if (true) return new MessageSend(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public callStartMethod callStartMethod() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   NodeToken n3;
   ...
   Token n10;
    ...
    n10 = jj_consume_token(SEMICOLON);
             n9 = JTBToolkit.makeNodeToken(n10);
     {if (true) return new callStartMethod(n0,n1,n3,n5,n7,n9);}
    throw new Error("Missing return statement in function");
  }

  static final public callNotifyMethod callNotifyMethod() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   NodeToken n3;
   ...
   Token n10;
    ...
    n10 = jj_consume_token(SEMICOLON);
             n9 = JTBToolkit.makeNodeToken(n10);
     {if (true) return new callNotifyMethod(n0,n1,n3,n5,n7,n9);}
    throw new Error("Missing return statement in function");
  }

  static final public callNotifyAllMethod callNotifyAllMethod() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   NodeToken n3;
   ...
   Token n10;
    ...
    n10 = jj_consume_token(SEMICOLON);
             n9 = JTBToolkit.makeNodeToken(n10);
     {if (true) return new callNotifyAllMethod(n0,n1,n3,n5,n7,n9);}
    throw new Error("Missing return statement in function");
  }

  static final public callWaitMethod callWaitMethod() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   NodeToken n3;
   ...
   Token n10;
    ...
    n10 = jj_consume_token(SEMICOLON);
             n9 = JTBToolkit.makeNodeToken(n10);
     {if (true) return new callWaitMethod(n0,n1,n3,n5,n7,n9);}
    throw new Error("Missing return statement in function");
  }

  static final public callJoinMethod callJoinMethod() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   NodeToken n3;
   ...
   Token n10;
    ...
    n10 = jj_consume_token(SEMICOLON);
             n9 = JTBToolkit.makeNodeToken(n10);
     {if (true) return new callJoinMethod(n0,n1,n3,n5,n7,n9);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Query Query() throws ParseException {
   ...
   Token n7;
    n1 = jj_consume_token(SCOMMENT1);
                    n0 = JTBToolkit.makeNodeToken(n1);
    n2 = Identifier();
    n4 = jj_consume_token(MHP);
               n3 = JTBToolkit.makeNodeToken(n4);
    n5 = Identifier();
    n7 = jj_consume_token(SCOMMENT2);
                    n6 = JTBToolkit.makeNodeToken(n7);
  ...
  static private boolean jj_3R_19() {
    if (jj_3R_16()) return true;
    if (jj_scan_token(DOT)) return true;
    if (jj_scan_token(NOTIFY)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_scan_token(RPAREN)) return true;
    if (jj_scan_token(SEMICOLON)) return true;
    return false;
  ...
  static private boolean jj_3R_20() {
    if (jj_3R_16()) return true;
    if (jj_scan_token(DOT)) return true;
    if (jj_scan_token(NOTIFYALL)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_scan_token(RPAREN)) return true;
    if (jj_scan_token(SEMICOLON)) return true;
    return false;
  ...
  static public QParJavaParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x800000,0x0,0x70000800,0x800000,0x400000,0x400000,0x0,0x70000800,0x400000,0x0,0x800,0x70000000,0x70000800,0x8200000,0x0,0x8200000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x800,0x1000a00,0x0,0x1000001,0x1000001,0x10,0x1000a00,0x1000001,0x800,0x0,0x1000200,0x1000a00,0x1800188,0x1000000,0x1800188,};
   }
  ...
  public QParJavaParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public QParJavaParser(java.io.InputStream stream, String encoding) {
    ...
    token_source = new QParJavaParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public QParJavaParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public QParJavaParser(QParJavaParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(QParJavaParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
